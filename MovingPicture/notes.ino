/*
-maybe have a step counter on loops that may lock up and have a reset function that restarts the script if the couter gets too high
...
-check the millis() overflow(I'm using long instead of unsigned long in the program) and make it overflow friendly - long will hold millis up to 24 days
