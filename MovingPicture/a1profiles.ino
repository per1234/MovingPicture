...
//test profile
const int fadeDelayMinSet = 2000;  //shortest shift time
const int fadeDelayMaxSet = 6000;  //the longest time that it will color shift.
...
const long strobeTimeMin=20;  //the minimum length of time the strobe is on - I don't think it needs powerup randomization
const long strobeTimeMax=30;  //the maximum length of time the strobe is on - I don't think it needs powerup randomization
const long strobeDelayMin=100;  //the minimum time between strobes
